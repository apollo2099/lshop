...
public class MyExceptionInterceptor extends AbstractInterceptor {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(MyExceptionInterceptor.class);

    protected Logger categoryLogger;
    protected boolean logEnabled = true;//默认可查看错误日志
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        try {
        	...
        	if (invocation.getAction() instanceof BaseAction) {
        		...
        		if (action.getExdev().equals("true")) {
					throw e;
				}
			}
            if (isLogEnabled()) {
