...
public class LvOrder extends com.gv.core.datastructure.impl.BasePo implements java.io.Serializable {
	...
	public void setCouponTotalPrice(Float couponTotalPrice) {
	...
	public String toString() {
		return "LvOrder [id=" + id + ", oid=" + oid + ", couponNum="
				+ couponNum + ", payStatus=" + payStatus + ", status=" + status
				+ ", memid=" + memid + ", userEmail=" + userEmail
				+ ", paymethod=" + paymethod + ", orderRemark=" + orderRemark
				+ ", breakRemark=" + breakRemark + ", sendRemark=" + sendRemark
				+ ", overtime=" + overtime + ", postprice=" + postprice
				+ ", totalPrice=" + totalPrice + ", couponTotalPrice="
				+ couponTotalPrice + ", thirdPartyOrder=" + thirdPartyOrder
				+ ", expressCompany=" + expressCompany + ", expressName="
				+ expressName + ", expressNum=" + expressNum + ", shipTime="
				+ shipTime + ", customerNo=" + customerNo + ", currency="
				+ currency + ", isdelete=" + isdelete + ", isServiceAudit="
				+ isServiceAudit + ", serviceAuditContent="
				+ serviceAuditContent + ", isFinanceAudit=" + isFinanceAudit
				+ ", financeAuditContent=" + financeAuditContent + ", isGroup="
				+ isGroup + ", groupCode=" + groupCode + ", flag=" + flag
				+ ", isBalance=" + isBalance + ", isBalanceFirst="
				+ isBalanceFirst + ", storeId=" + storeId + ", code=" + code
				+ ", createTime=" + createTime + ", modifyTime=" + modifyTime
				+ ", modifyUserId=" + modifyUserId + ", modifyUserName="
				+ modifyUserName + ", atrr=" + atrr + ", atrr1=" + atrr1
				+ ", atrr2=" + atrr2 + ", atrr3=" + atrr3 + ", startTime="
				+ startTime + ", endTime=" + endTime + ", startOverTime="
				+ startOverTime + ", endOverTime=" + endOverTime
				+ ", auditFlag=" + auditFlag + ", orderFlag=" + orderFlag
				+ ", statusFlag=" + statusFlag + ", detailsList=" + detailsList
				+ ", list=" + list + ", couponCodeList=" + couponCodeList
