...
public class LvOrderDetails extends com.gv.core.datastructure.impl.BasePo implements java.io.Serializable {
	...
	public String toString() {
		return "LvOrderDetails [id=" + id + ", orderId=" + orderId
				+ ", productCode=" + productCode + ", oprice=" + oprice
				+ ", oremark=" + oremark + ", pnum=" + pnum + ", postPrice="
				+ postPrice + ", currency=" + currency + ", isDelete="
				+ isDelete + ", isPackage=" + isPackage + ", pcode=" + pcode
				+ ", couponCode=" + couponCode + ", couponPrice=" + couponPrice
				+ ", storeId=" + storeId + ", code=" + code + ", createTime="
				+ createTime + ", modifyTime=" + modifyTime + ", modifyUserId="
				+ modifyUserId + ", modifyUserName=" + modifyUserName
				+ ", atrr=" + atrr + ", atrr1=" + atrr1 + ", atrr2=" + atrr2
				+ ", atrr3=" + atrr3 + ", targetProductCode="
				+ targetProductCode + "]";
	}
