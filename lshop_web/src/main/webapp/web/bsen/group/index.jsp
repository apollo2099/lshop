...
<title>Group Buying-banana Mall</title>
<%@include file="/web/bsen/common/header.jsp" %>
<link href="${resDomain}/bsen/res/group/css/self.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${resDomain}/bsen/res/js/jquery-1.4.4.min.js" ></script>
<script type="text/javascript" src="${resDomain}/bsen/res/js/FomrValidate.js" ></script>
<script type="text/javascript" src="${resDomain}/bsen/res/js/jquery.validate.min.1.8.1.js" ></script>
<script type="text/javascript" src="${resDomain}/bsen/res/js/jquery_validate_extend.js" ></script>
<script type="text/javascript" src="${resDomain}/bsen/res/js/jquery.form.js" ></script>
<script type="text/javascript" src="${resDomain}/bsen/res/js/cookie.js"></script>

<script type="text/javascript" src="${resDomain}/bsen/res/js/header.js" ></script>
<script type="text/javascript" src="${resDomain}/bsen/res/js/regandlog.js"></script>
	...
	<div class="tuan_top">
		...
		<div class="tuan_content">
			<div class="tuan_content_l">
					...
					<c:if test="${mark==1}"><a href="javascript:subGroup();"><img src="${resDomain}/bsen/res/group/images/buy.gif" width="117" height="50" border="0" /></a></c:if>
					<c:if test="${mark==2}"><img src="${resDomain}/bsen/res/group/images/tuan_jjks.gif" width="117" height="50" border="0"/></c:if>
					<c:if test="${mark==3}"><img src="${resDomain}/bsen/res/group/images/tuan_jieshu.gif" width="117" height="50" border="0"/></c:if>
					</div>
					...
					<input type="hidden" name="lvGroupBuy.code" value="${groupBuy.code}"/>
						...
						<ul>
							<li class="long bold">${lvStore.currency} <u:formatnumber value="${groupBuy.primeCost }"  type="number" groupingUsed="false" maxFractionDigits="2"/></li>
						...
						<ul>Quantity 
						    <a href="javascript:changeNum('del');"><img src="${resDomain}/bsen/res/group/images/jian.gif" border="0"/></a>
                			<input type="text"  class="input3" id="num" name="shopNum" value="1" onkeypress="onlyNumber(event)"/>
                			<a href="javascript:changeNum('add');"><img src="${resDomain}/bsen/res/group/images/jia.gif" border="0"/></a>
						</ul>
						...
						<p><img src="${resDomain}/bsen/res/group/images/tuan_01.gif"/></p>
					</form>
					</div>
			</div>
	...
	<div class="indextj commargin1">
        <div class="product_item">
            <ul>
	              ...
	              <li id="index${propertyNum+1}" <c:if test="${propertyNum==0}">class="choose"</c:if>><a href="javascript:MainItem(${propertyNum+1});">Comments<font class="redfont">（${commentNum}）</font></a></li>
            </ul>
      </div>	
