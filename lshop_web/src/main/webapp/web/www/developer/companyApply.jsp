		...
		function checkDate(form){
			...
			var issubmit=true;
	   		if(!checkInput(company,128)){
				showMsg("company","請輸入128長度以內公司名稱");
				issubmit= false;
			}
	   		if(!checkInput(idNum,18)){
				showMsg("idNum","請輸入18長度以內的營業執照註冊號");
				issubmit= false;
			}
		    ...
		    if(file_val!=""&&!filetest.test(file_val)){
		      ...
		      $("#file_name").val(file_val);
	   		...
	   		if(!checkInput(name,32)){
				showMsg("contactName","請輸入32長度以內的聯繫人");
				issubmit= false;
			}
	   		...
	   		if(!checkInput(address,128)){
				showMsg("address","請輸入128長度以內的公司地址");
				issubmit= false;
			}
...
<div class="application1" style="height:420px">
   <div class="posit">
      <h2 class="bt3" id="nbt">
	    <p class="home"><img src="${resDomain}/www/res/images/icon02.gif" /></p><p><a href="${storeDomain}/web/index!toIndex.action">首頁</a> > <a href="${storeDomain}/web/developer!developerIndex.action">註冊開發者</a>  > 企業開發者</p>
	  </h2>
   </div> 
   <div class="clear"></div> 
  ...
  <tr>
    <td width="35%" height="40" align="right"><p><span class="star">*</span>公司名稱：</p></td>
  ...
  <tr>
    <td height="40" align="right"><p><span class="star">*</span>營業執照註冊號：</p></td>
    <td height="40"><input type="text" name="developer.idNum" id="idNum"  value="${developer.idNum}" class="inttext"/></td>
    <td height="40"><span class="star errormsg"><c:choose><c:when test="${status eq '3'}">營業執照註冊號已被註冊</c:when></c:choose></span></td>
  </tr>
  <tr>
    <td height="40" align="right"><p><span class="star">*</span>營業執照掃描件：</p></td>
    <td height="40">
     <div class="upload">
    	 <div class="upload">
  ...
  <tr>
    <td height="40" align="right"><p><span class="star">*</span>聯繫人姓名：</p></td>
