...
<div id="sc_top">
    		...
    		<div id="help">
				<ul>
	            	...
	            	<li class="dl" id="loginId"><a href="javascript:onshow('tx_b','loginDiv');">登錄</a></li>
	            	 --%>
	            	<li class="dl" id="loginId"><a href="javascript:toLogin('${storeDomain }');">登錄</a></li>
	...
	<div class="sc_logo">
    	<div class="sc_log">
    		...
    		<div id="c_nav_menu" class="sc_menu_A_l">
    		   <!-- 菜单自定义标签 -->
	 		   <cus:navigation style="1"></cus:navigation>
	 		</div>
      
		  	<div class="search">
		  		<div class="inner_srarch">
		  		<form action="${storeDomain}/web/store!searchProducts.action" method="post" class="sousuo_bg" id="searchForm">
		  			<input name="str" type="text" maxlength="30" class="sc_wb" id="searchContent" <c:if test="${not empty searchContent}">value="${searchContent}"</c:if><c:if test="${empty searchContent}">value="TVpad4"</c:if>  "/>
		  			<input name="" type="submit" class="smit_src" value=""/>
		  		</form>
		  		<%-- <p class="reci">熱門搜索：<span><st:tagStyle></st:tagStyle></span></p> --%>
		  		</div>
		  	</div>
		  	<div class="clear"></div>
		</div>
	...
	<div id="tx_b" style="top:124px;position: absolute;display: none;z-index:9999;">
		<div class="pop_up_box" style="background:white;">
         ...
         <!-- 
         <a href="/web/threeauth!weibo.action"><img src="${resDomain}/www/res/images/xl.png" alt="微博登陆"/></a>
         <a href="#"><img src="images/wx.png" alt="微信登陆"/></a>
         <a href="#"><img src="images/zfb.png" alt="支付宝"/></a>
         -->
          </div>
	</div>
