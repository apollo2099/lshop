...
<div id="content_xz">
    <div id="ad_one">
    	<div class="btn"><a href="http://en.mtvpad.com/3/index.html"></a></div>
        <div id="ad_img">
          <img src="${resDomain}/www/res/images/tvpad4zt_trade/bananer1bj.jpg"/>
        </div>        
    </div>
    ...
    <div id="coupon">
    	<div id="coupon_cash">
        	<img src="${resDomain}/www/res/images/tvpad4zt_trade/cou.jpg" alt="TVpad以旧换新"/>
             <form class="cou_search" action="http://www.mtvpad.com/web/activity!getCouponByActivityLinkLogout.action?activityCode=4aea88e72b504e06ac0ed3117bbed336" method="post" onsubmit="return checkMac()">
            	<input name="sourceUrl" type="hidden" value="http://www.mtvpad.com/3/index.html"/>
            	<input class="cousearch_tet1" id="userEmail" name="userEmail" type="text"  dvalue="輸入郵箱" />
            	<input class="cousearch_tet3" id="macCode" name="macCode" type="text" dvalue="輸入舊機Mac碼領取" onblur="findMac()"/>
    ...
    <div id="ad_two">
     ...
     <div id="rule">
        ...
        <div class="rule_buttom_d"> 
            <p class="em_one">Q:</p><p class="em_th">在哪裡查看MAC碼？一個MAC碼能重複使用嗎？</p>
        </div>
        <div class="rule_buttom_d rule_buttom_e"> 
			<p class="em_one">A:</p><p class="em_th">請在盒子的背面查看（附圖）</p>
               <img src="${resDomain}/www/res/images/tvpad4zt_trade/img1.jpg" alt="TVpad以旧换新"/></p>
		</div>
        
        <div class="rule_buttom_d">    
            <p class="em_one">Q:</p><p class="em_th">在哪裡輸入優惠券？</p>
		</div>
        <div class="rule_buttom_d rule_buttom_e"> 
        	<p class="em_one">A:</p><p class="em_th">請在“填寫核對訂單”頁面的左下角，點擊“（+）使用優惠券抵消部分總額，單筆訂單僅可使用一次”處輸入優惠券碼，並點擊“確定”按鈕，即可減免相應金額。請注意優惠券的使用日期，為確保您的權益，請儘快使用！</p>
		</div>	
            
        <div class="rule_buttom_d">   
            <p class="em_one">Q:</p><p class="em_th">優惠券是否一定要在TVpad商城使用？Amazon,Aliexpress授權店鋪可以用嗎？</p>
		</div>
        <div class="rule_buttom_d rule_buttom_e"> 	
            <p class="em_one">A:</p><p class="em_th">優惠券是TVpad官網專屬<a href="www.mtvpad.com">(www.mtvpad.com)</a>，其他線上管道途徑無效</p>
		</div>
        
        <div class="rule_buttom_d">	
         	<p class="em_one">Q:</p><p class="em_th">兌換新TVpad4的盒子後，舊盒子還能繼續使用嗎？</p>
		</div>
        <div class="rule_buttom_d rule_buttom_e"> 
            <p class="em_one">A:</p><p class="em_th">舊盒子即將停機，無法繼續使用，無法繼續使用！請抓緊時間換新機。現在換新機立減130元美金，包郵送貨上門！</p>
        </div>    
        
        <div class="rule_buttom_d">
            <p class="em_one">Q:</p><p class="em_th">支付完成之後幾天可以發貨？大概多少天可以收貨？</p>
		</div>
        <div class="rule_buttom_d rule_buttom_e"> 
            <p class="em_one">A:</p><p class="em_th">因以舊換新期間發貨量巨大，支付之後約一個星期之內發貨，具體各地區到貨時間可到幫助中心物流配送中查看。期間請您保持通訊方式順暢，確保順利收貨。</p>
        </div>
