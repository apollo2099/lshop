...
<div id="content_xz">
	<div id="ad_one">
    	<div id="ad_img">
            ...
            <map name="Map" id="Map">
                <area shape="rect" coords="72,339,280,405" href="http://en.mtvpad.com/169/index.html" target="_blank" />
            </map>
        </div>
    </div>
    ...
    <div id="coupon">
    	<div id="coupon_cash">
            ...
            <form class="cou_search" action="http://www.mtvpad.com/web/activity!getCouponByActivityLinkLogout.action?activityCode=ce01572904c64e3cba9baa364bee49b5" method="post" onsubmit="return checkMac()">
                ...
                <input id="search_two" class="cousearch_sub" type="submit" value="" >
            </form>
            <div class="clear"></div>
        </div>
        <div id="flow">
