...
<form id="macForm" action="/web/shopCart!toQuickOrder.action#md" method="get" target="_blank">
   ...
   <input type="hidden" name="sourceUrl" value="http://www.mtvpad.com/3/index.html"/>
</form>


<ul id="tbox">
    <li><a id="huanxin" href="/web/shopCart!toQuickOrder.action?shopFlag=tvpadcn&productCode=6f2390c6bd794e28a34fc5dc512e4a2e&sourceUrl=http://www.mtvpad.com/3/index.html#md"  target="_blank"></a></li>
...
<!--bananer-->
<div class="mainpage1">
	<a class="btn1" href="/web/shopCart!toQuickOrder.action?shopFlag=tvpadcn&productCode=6f2390c6bd794e28a34fc5dc512e4a2e&sourceUrl=http://www.mtvpad.com/3/index.html#md"  target="_blank"><img src="${resDomain}/www/res/tvpad4zt_mac/images/btn_1.png" /></a>
    <a class="btn2" href="http://en.mtvpad.com/3/index.html">TO English page</a>
...
<div class="mainpage2">
	...
	<div class="mainpage2_buttom">
    	<a class="sale" href="/web/shopCart!toQuickOrder.action?shopFlag=tvpadcn&productCode=6f2390c6bd794e28a34fc5dc512e4a2e&sourceUrl=http://www.mtvpad.com/3/index.html#md"  target="_blank">立減$130换购</a>
    </div>	
</div>
<!--瞭解TVpad4-->
<div class="mainpage3">
