		...
		<div class="content_main">
			...
			<%@include file="/web/www/user_center/leftFrame.jsp" %>
			 ...
			 <div class="right_frame">
			 	<h1><span class="s_r"><font class="bfont"><img src="${resDomain}/www/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">首頁</a>--><a href="/web/userCenterManage!getAccount.action">用戶中心</a>--><a>提交西聯匯款成功</a></font> </span></h1> 
				<div class="usercenter_box">
					...
					<a href="/web/userOrder!getOrderlist.action"><img src="${resDomain}/www/res/images/user_center_btn04.gif" width="101" height="34" border="0" /></a>												
				</div>
			</div>	
		</div>	
