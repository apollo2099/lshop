...
<title>banana商城_订单提交成功</title>
<!-- 加载公共JS -->
<%@include file="/web/mbmcn/common/top.jsp" %>
<script type="text/javascript" src="${resDomain}/mbmcn/res/js/Configure-mall.js"></script>
...
<article>
  <div class="subminsucess">
    ...
    <div class="sucwwtip">
      您的订单已提交成功，请及时支付！
      <br />订单编号：<br /><span class="ord"><a href="/web/userOrder!viewOrderInfo.action?oid=${param.oid }">${param.oid }</a></span>
    </div>
  </div>
