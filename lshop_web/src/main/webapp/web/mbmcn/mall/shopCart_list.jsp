...
<script type="text/javascript" src="${resDomain}/mbmcn/res/js/cart.js"></script>
</head>
       ...
       <div class="settleaccounts">
           <div class="settleaccounts_inner">
              <div class="settleaccounts_inner_left">
                 ...
                 <span>商品总金额：</span><i>${ob[0].currency } <font id="allAmount${outStatus.count }">${ob[2] }</font></i>
              </div>
              ...
              <li>
                 ...
                 <div class="totalconts">
                    ...
                    <div>
                       <table width="100%" border="0">
                         <tr>
                           <td width="48%" valign="middle" class="imgprcont"><span class="imgjiag">${ob[0].currency } <font id="_${outStatus.count }oPrice${status.count }">${obj[0].shopPrice }</font></span> X</td>
