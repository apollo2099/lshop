...
<form action="${storeDomain}/web/regeditAccount.action" id="regedit" method="post" >
  ...
  <tr>
	...
	<tr>
		...
		<td height="80" align="left" >
			<img src="/web/phoneimager.jsp" id="rcId" style="cursor:pointer;" name="code"
  ...
  <tr>
    <td height="80" colspan="3"><input type="button" id="registerbut" onclick="submitRegister()" value="注 册"  class="user_reg_bt"/></td>
    </tr>
</table>
</form>
