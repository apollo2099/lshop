...
<script type="text/javascript" src="${MallPath}${resDomain}/mbmcn/res/js/jquery-1.10.2.min.js"></script>
...
<script type="text/javascript" src="${resDomain}/mbmcn/res/js/pay.js"></script>
