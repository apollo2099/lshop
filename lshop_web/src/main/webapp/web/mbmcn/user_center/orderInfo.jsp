			...
			<div class="odderdetial1">
				<table width="100%" border="0" align="center">
					...
					<tr>
						...
						<td height="25" valign="top" class="jg" width="48%">${lvOrder.currency} ${lvOrder.totalPrice}</td>
						<td width="25%" height="20" valign="top"></td>
					</tr>
							...
							<div>
								<table width="100%" border="0">
									<tr>
										...
										<td valign="middle" class="imgjiag">${lvOrder.currency} ${obj[2] }</td>
									</tr>
								</table>
							</div>
						</div>
