		...
		<div class="content_main">
			...
			<%@include file="/web/mbmcn/user_center/leftFrame.jsp" %>
			 ...
			 <div class="right_frame">
			 	<h1><span class="s_r"><font class="bfont"><img src="${resDomain}/mbmcn/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">首页</a>--><a href="/web/userCenterManage!getAccount.action">用户中心</a>--></font> 提交西联汇款成功</span></h1> 
				<div class="usercenter_box">
					<div class="buy_order01">
						<ul class="title">订单提交成功</ul>	
							<li class="pp"><img src="${resDomain}/mbmcn/res/images/suc.gif" /></li>
					...
					<a href="/web/userOrder!getOrderlist.action"><img src="${resDomain}/mbmcn/res/images/user_center_btn04.gif" width="101" height="34" border="0" /></a>												
				</div>
			</div>	
		</div>	
