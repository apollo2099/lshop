...
<link href="${MallPath}${resDomain}/mbmcn/res/css/style.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="${MallPath}${resDomain}/mbmcn/res/js/jquery-1.4.4.min.js"></script>
<script type="text/javascript" src="${MallPath}${resDomain}/mbmcn/res/js/FomrValidate.js"></script>
<script type="text/javascript" src="${MallPath}${resDomain}/mbmcn/res/js/header.js"></script>
<script type="text/javascript" src="${MallPath}${resDomain}/mbmcn/res/js/hammer.js"></script>
<script type="text/javascript" src="${MallPath}${resDomain}/mbmcn/res/js/cart.js"></script>
<title>banana商城_购物车</title>
</head>
<body>
