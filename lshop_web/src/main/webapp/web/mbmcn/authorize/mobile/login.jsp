...
<body>
   ...
   <div class="top">
      ...
      <div class="shopping">
        <div class="shoplebg1">
            <div class="shopicon1"><a href="/index.html"></a></div>
         </div>
      </div>
      <div class="title">
        <h1>同步登陆</h1>
...
<article>
  <div style="margin-top:20px; background-color:#ebecee" class="mycomment">
     <div class="micor_commentbt">
       <span id="curspan1">已有账号登陆</span>
       <span>新用户注册</span>
       
     </div>
    
     <div class="myconmmentsubdivbox" style="padding-bottom:0;display:block;background-color:#ebecee">    
  ...
  <tr>
    ...
    <td height="80" colspan="2" align="right"  class="fonsi">
      <div  class="inputd">
        <input type="text"  class="inpu"  value="请输入Email地址" name="uname" id="l_uname"
        defalt="请输入Email地址"/>
        <div class="tip">
          <em></em>
  ...
  <tr>
    <td height="80" colspan="3"><input type="button" value="登 录"  class="logins" onclick="authloginformSubmit()" id="loginbut"/></td>
    </tr>
</table>
</form>
    </div>
   ...
   <!-- 注册部分 --> 
     <div class="replayconmmentsubdivbox" style="background-color:#ebecee ">  
  ...
  <tr>
    ...
    <td height="80" colspan="2" align="right" >
      <div  class="inputd">
        <input type="text"  class="inpu" value="" name="code" defalt="" id="r_code"
        style="text-indent:0; text-align:center" maxlength="4"/>
        <div class="tip">
          <em></em>
          <span class="errInfo"></span>
  ...
  <tr>
    <td height="80" colspan="3"><input type="button" value="注 册" class="logins" onclick="authregistformSubmit();" id="registerbut"/></td>
    </tr>
</table>
</form>
     </div>
