		...
		$.ajax({
		   ...
		   success: function(jsonData){
		   		...
		   		if(data.length>=1){
		   			...
		   			$("#provinceIdDiv").append("<span class='spanchose' onClick='provinceChange(this)'>请选择州/省</span>");
		   			...
		   			$("#provinceIdDiv").remove();
		   			$("#provinceNameDiv").remove();
		   			$("#test").after("<div class='shose_2' id='provinceNameDiv'><input type='text'  class='inpu' id='provinceName' value='请输入州/省' name='lvAccountAddress.provinceName' defalt='请输入州/省'/></div>");
