		...
		$("#regedit").validate({
			...
			messages: {
				'lvAccount.nickname': {
					...
					isUnlawful: "<font color='red'>Nickname shall not cover improper characters!</font>",
					minlength: "<font color='red'>Nickname shall cover at lease 2 characters!</font>",
					maxlength: "<font color='red'>Nickname shall be no longer than 32 characters!</font>",
					chrnum: "<font color='red'>Nickname shall not be in Chinese!</font>"
				},
				'lvAccount.pwd': {
				...
				truePwd: {
					required: "<font color='red'>Please enter and confirm your password!</font>",
				...
				'lvAccount.email': {
					...
					maxlength: "<font color='red'>The Email address shall not be longer than 32 characters!</font>"
				}
			},
