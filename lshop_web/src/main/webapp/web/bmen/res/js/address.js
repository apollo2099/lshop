				...
				$.ajax({
				   ...
				   success: function(jsonData){
				   		...
				   		if(data.length>=1){
				   			...
				   			$("#provinceName").after("<input class='input04' type='hidden' name='lvAccountAddress.provinceName' id='provinceNameId'  value=''/>");
				   		}else{
				   			$("#provinceName").remove();
				   			$("#provinceNameId").remove();
				   			$("#test").after("<input type='text' class='input04' name='lvAccountAddress.provinceName' id='provinceName' class='input3' value='State/Province' onfocus='if(this.value==&quot;State/Province&quot;) this.value=&quot;&quot;' onblur='if(this.value==&quot;&quot;)this.value=&quot;State/Province&quot;'/>");
