...
function subForm() {
	...
	if (js.assert.isNull("rcardNum", "Please enter card No.")) {return false;}
	if (js.assert.isNull("cardPwd", "Please enter password")) {return false;}
	if (js.assert.isNull("validCode", "Please enter auth Code")) {return false;}
		var result;
