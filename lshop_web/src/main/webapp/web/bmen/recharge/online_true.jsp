...
.addrList{display:none;padding-left:158px;padding-top: 10px}
</style>
<!-- 加载公共JS -->
<%@include file="/web/bmen/common/top.jsp"%>
<script type="text/javascript" src="${resDomain}/bmen/res/js/myjs.js"></script>
...
$(function(){
	$.getScript("${resDomain}/bmen/res/js/area_cn.js");
...
<div class="content_main">
    ...
    <div class="usercenter_box">
          <form action="/web/recharge!toPay.action" method="post"  onsubmit="return doAction()" id="addressFormVbId">
            ...
            <div class="user_center_right">
             ...
             <div style="padding-left:0px;display:none;" id="payInfoId">
              <div id="objAddr">
			 <div>
			 <label for="btnAddr" style="margin-left:48px;float:left;">Billing information  <s:if test="#request.addressList!=null"> <span style="padding-left: 63px;color: bl;color: #B68571;">Billing Address：</span> </s:if> </label>
        ...
        <br/>
              <ul style="margin-bottom:10px;">
						...
						<li class="wd2"><input name="lvAccountAddress.relName" class="input4"  type="text" id="relName"/>
						</li>
				    </ul>
				...
				<ul style="margin-bottom:10px;">
					...
					<input type="text" name="lvAccountAddress.provinceName" id="provinceName" class="input04" value="State/Province"  onfocus="if(this.value=='State/Province')this.value=''" onblur="if(this.value=='')this.value='State/Province'"/> 
						...
						- <select name="lvAccountAddress.contryId" id="contryId" onchange="contryChange()"  style="width:120px;" class="input4">
				...
				<ul style="margin-bottom:10px;">
					...
					<li class="wd2">
					  <input name="lvAccountAddress.postCode" id="postCode" class="input4"  type="text" />
					</li>
				</ul>
  ...
  <div class="im_remind"  id="win_1" style="top:150px;position: absolute;display: none;z-index:9999;">
    ...
    <p class="close"><a href="javascript:void(0)" onclick="hide('win_1')"><img src="${resDomain}/bmen/res/images/close.gif" border="0" /></a></p>
    <ul>
        <li>
