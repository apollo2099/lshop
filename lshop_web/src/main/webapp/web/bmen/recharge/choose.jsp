  ...
  <div class="right_frame">
    ...
    <div class="usercenter_box">
      ...
      <s:if test="#request.isOrNOLoginFlag!=0">
        ...
        <ul>
          <li> <a href="/web/recharge!card.action"><img src="${resDomain}/bmen/res/images/cz01-.gif" border="0" /></a><span>Recharge V coin by filling in the recharge card No. and password
</span> </li>
          <li> <a href="/web/recharge!online.action"><img src="${resDomain}/bmen/res/images/cz02-.gif" border="0" /></a><span>Recharge V coin by online payment</span> </li>
        </ul>
      </div>
      <s:if test="#request.isOrNOLoginFlag!=0">
