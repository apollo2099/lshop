  ...
  <div class="right_frame">
		...
		<div class="usercenter_box">
		  <div class="user_center_right">
            <ul>
	          <li class="center"><img src="${resDomain}/bmen/res/images/suc.gif" /> <font style="font-size: 14px; font-weight: bold;">You have to cancel the order ${charge.rnum} payment transactions!</font></li>
			</ul>
			<ul>
			  <li class="center">
