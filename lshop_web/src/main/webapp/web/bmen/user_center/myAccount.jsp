		...
		<div class="content_main">
			...
			<%@include file="/web/bmen/user_center/leftFrame.jsp" %>
			 ...
			 <div class="right_frame">
			 	<h1><span class="s_r"><font class="bfont"><img src="${resDomain}/bmen/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">Home</a> --><a href="/web/userCenterManage!getAccount.action"> User Center</a> --></font> My Account</span></h1> 
				<div class="usercenter_box">
					<ul class="user_center_pp"><img src="${resDomain}/bmen/res/images/personel_center_icon01.gif" /></ul>	
					<ul class="user_center_tx">
					  <li><font class="fontwz" id="lvnicknameId"></font>,welcome! Your last visit time：<span id="lasttimeId"></span>			    
					  </li>
					</ul>
					<ul class="user_center_tips">
						...
						<li class="none">Account balance:<font class="redfont fontwz"> ${mybalance }V </font>(Your account balance is low, you can Recharge 
						<font class="redfont"><a href="/web/recharge!list.action">here</a></font>)
					</ul>		
				</div>
		  </div>
			 <!--End right_Frame-->
