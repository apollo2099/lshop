		...
		<div class="right_frame">
			<h1>
				<font class="bfont"><img
					src="${resDomain}/bmen/res/images/icon02.gif" /><a
					href="/index.html">Home</a> --><a
					href="/web/userCenterManage!getAccount.action"> User Center</a> --></font> My prizes
			</h1>
			
			<div class="order_record">
			<table id="c_prize_list" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#e3e2e2">
              <tr>
               <td width="35%" height="30" align="center" valign="middle" bgcolor="#f2f1f1">Prize</td>
               <td width="25%" height="30" align="center" valign="middle" bgcolor="#f2f1f1">Winning Time</td>
               <td width="15%" height="30" align="center" valign="middle" bgcolor="#f2f1f1">Redemption Deadline</td>
               <td width="15%" height="30" align="center" valign="middle" bgcolor="#f2f1f1">Operate</td>
              </tr>
