		...
		<div class="content_main">
			...
			<%@include file="/web/bmen/user_center/leftFrame.jsp" %>
			 ...
			 <div class="right_frame">
			 	<h1><span class="s_r"><font class="bfont"><img src="${resDomain}/bmen/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">Home</a> --><a href="/web/userCenterManage!getAccount.action"> User Center</a> --></font> My Order</span></h1>  
		        ...
		        <tr>
		          <td height="40" colspan="4" bgcolor="#F2F1F1">
		          	...
		          	<s:if test="#request.lvOrder.payStatus==0">
		          		<font class="redfont">Await payment</font>&nbsp; <img src="${resDomain}/bmen/res/images/personel_center_icon03.gif" width="16" height="16" /> 
		        ...
		        <tr>
		          ...
		          <td  width="263" height="30" bgcolor="#FFFFFF" style="text-align:center">${lvOrder.currency} ${lvOrder.totalPrice}</td>
		       ...
		       <s:if test="#request.lvOrder.status!=0">
		        ...
		        <s:if test="#request.lvOrder.payStatus!=0 and #request.lvOrder.paymethod==4">
					...
					<div class="buy_order">
								...
								<ul class="sum">Total：${lvOrder.currency} ${allAmount} <c:if test="${not empty coupon}">- Coupon：${lvOrder.currency} ${lvOrder.couponTotalPrice} </c:if> + Freight:${lvOrder.currency} ${lvOrder.postprice }</a></ul>
