...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>	
		...
		<div class="right_frame">
			 	<h1><span class="s_r"><font class="bfont"><img src="${resDomain}/bmen/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">Home</a> --><a href="/web/userCenterManage!getAccount.action"> User Center</a> --></font> Tracking Shipments</span></h1> 
				<div class="express">
					<ul class="express_t">
					...
					<ul>
						...
						<li class="tips"><img src="${resDomain}/bmen/res/images/pos_icon.gif" width="19" height="19" /> The above information is offered by related logistics Company. If there is no tracking information offered or you have questions, please visit <a href="#">DHL</a> official website or call the customer service.</li>
					</ul>
					</s:if>
					<s:else>
						<li class="tips"><img src="${resDomain}/bmen/res/images/pos_icon.gif" width="19" height="19" /> For tracked information or any inquiry, please visit our official website, we hereby show you several frequently used website.</li>
