	...
	<c:if test="${not empty addressList}">
		<c:foreach items="${addressList}" var="address" varStatus="sta">
			...
			<ul id="address${sta.count }" deliveryId="${address.contryId }">
				...
				<li class="de">
					<a href="#" addrCode="${address.code }" class="addrEditBtn">Edit</a>
				</li>
				<li class="de">
					<a href="#"
		...
		<ul>
			...
			<li class="wd2">
				<input name="lvAccountAddress.relName" class="input4"
					type="text" /><font>（English only）</font>
			</li>
		</ul>
		<ul>
			<li class="wd1">
...
<ul>
	<li class="btn">
		<input id="addrBtn" class="btn07" type="button" value="Confirm shipping address" />
		The shipping address can’t be changed after confirming, please fill in it carefully.
	</li>
</ul>
</div>
<script>
