...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			...
			<div class="fill_orders">
				<div class="fill_orders01">
					<c:if test="${not empty errorMsg}">
						<div class="fill_orders_tips"><img src="${resDomain}/en/res/images/pos_icon.gif" width="19" height="19"/>${errorMsg}</div>
					</c:if>				
					<!-- 收货人信息 -->
							...
							<ul>
								...
								<li class="wd2">
									...
									<input type="hidden" name="lvAccountAddress.contryId"
										id="contryId" value="" />										
									<span id="addressInfo"><span class="kbqc">Please enter a correct address (in English).</span></span>
								</li>
							</ul>
							<ul>
								<li class="wd1">
		...
		<div class="coupons" id="editCoupon">
			<p><a href="javascript:void(0);" id="editCouponBtn">(+) Use Coupon: Each order can only be discounted by one coupon.</a> </p>
		</div>
		<div class="coupons" id="listCoupon" style="display:none;">
			<p><a href="javascript:void(0);" id="listCouponBtn">(-) Use Coupon: Each order can only be discounted by one coupon.</a><a href="javascript:void(0);" id="couponCancelBtn"><font class="bluewz">Cancel</font></a></p>
			<ul>
				...
				<li><input id="useCouponCodeBtn" name="coupon" type="radio" value="" couponval="0.0" <c:if test="${empty couponList}">checked="checked"</c:if> />Use coupon code
					...
					<p id="couponCodeUse" class="use" style="display:none;"><span id="couponCodeName"></span><a href="javascript:void(0);" id="couponCodeCancelBtn">Cancel</a></p>
				</li>
				</li>
			</ul>
		</div>
