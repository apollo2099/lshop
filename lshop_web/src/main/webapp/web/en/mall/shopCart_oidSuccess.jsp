...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Submit order successfully_TVpad Mall</title>
		...
		<script type="text/javascript" src="${resDomain}/en/res/js/Configure-mall.js"></script>
	...
	<body>
		...
		<div class="message1">
			 <ul>
      <li class="pp"><img src="${resDomain}/en/res/images/suc.gif" /><br />  You have successfully placed your order!<br /> We’ll arrange delivery as soon as possible, please keep your phone available!</li>
			...
			if(data.activity){
				...
				for(var i=0;i<data.activity.length;i++){
					if(data.activity[i].givenTypeNum === 1) {
						html += '<li><img src="http://res.mtvpad.com/en/res/images/zq.jpg"  /> '+data.activity[i].activityTitle+'</li>';
					} else {
						html += '<li><img src="http://res.mtvpad.com/en/res/images/cj.jpg"  /> '+data.activity[i].activityTitle+'</li>';
					}
				}
				if(html){
