...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${resDomain}/en/res/js/My97DatePicker/WdatePicker.js"></script>	
			 ...
			 <div class="right_frame">
				...
				<div class="usercenter_box">
					<div class="orderlist">
						...
						<ul>
			  				<li class="wdx7">Order No.：<input name="orderId"  type="text" class="input6" value="${orderId }"/> </li>
			   				<li class="wdx7">Seller：<input name="storeName"  type="text" class="input4" value="${storeName }"/> </li>
			   				<li class="wdx7">Time of Order：<input name="startTime"  readonly="readonly" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',lang:'en'})" type="text" class="input5"  value="${startTime }"/> to <input name="endTime"  readonly="readonly" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',lang:'en'})" type="text" class="input5" value="${endTime }"/></li>
				  		</ul>
				        <ul class="cx">
				            <li class="wdx7">Coupon：<input name="couponCode"  type="text" class="input6" value="${couponCode }"/> </li>
			   				<li class="wdx7">Status：
			    				<select class="input3" name="oidStatus">
				...
				<c:if test="${page.totalPage>1}">
				  <u:newPage href="/web/userOrder!getOrderlist.action?payStatus=${payStatus}&status=${status}&orderId=${orderId }&storeName=${storeName }&startTime=${startTime }&endTime=${endTime }&oidStatus=${oidStatus }&couponCode=${couponCode }&page.pageNum=@" language="en"></u:newPage>
