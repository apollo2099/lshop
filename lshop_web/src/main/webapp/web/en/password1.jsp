...
<div  class="xlhk_main">
  ...
  <ul>
     <li>
       <p class="wd4"> <span><font class="fontwz redfont">Your application has been submitted; please login your email to change your password within 24 hours!</font></span> <span>(The mail may sometimes be considered as spam. If you do not receive the mail, please click "Back" to submit your application again.)</span> </p>
     </li>
     <li>
       <p class="wd4">
         <input type="button" onclick="javascript:window.location.href='<%=url%>';" value="Back"  class="user_center_bt02" />
       </p>
     </li>
     <div class="cb"></div>
  </ul>
