  ...
  <div class="right_frame">
		...
		<div class="usercenter_box">
		  <div class="user_center_right">
            <ul>
	          <li class="center"><img src="${resDomain}/en/res/images/fail.gif" /> <font class="suc">Payment failed!</font></li>
			  <li><p class="text1">Order No.：</p> <p><font class="bluefont">${charge.rnum}</font> </p></li>
