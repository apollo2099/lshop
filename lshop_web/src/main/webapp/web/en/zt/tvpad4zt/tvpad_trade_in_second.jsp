...
<div id="content_xz">
	<div id="ad_one">
    	<div id="ad_img">
            ...
            <map name="Map" id="Map">
                <area shape="rect" coords="89,386,280,435" href="http://www.mtvpad.com/2/index.html" target="_blank" />
            </map>
        </div>
    </div>
    ...
    <div id="coupon">
    	<div id="coupon_cash">
            ...
            <form class="cou_search" action="http://en.mtvpad.com/web/activity!getCouponByActivityLinkLogout.action?activityCode=dc950d8ed8224021821cdf94330c2abc" method="post" onsubmit="return checkMac()">
