...
<form id="macForm" action="/web/shopCart!toQuickOrder.action#md" method="get" target="_blank">
   ...
   <input type="hidden" name="sourceUrl" value="http://en.mtvpad.com/3/index.html"/>
</form>

<ul id="tbox">
    <li><a id="huanxin" href="/web/shopCart!toQuickOrder.action?shopFlag=tvpaden&productCode=0e55accec6f44cd484dc6ca30ba46b3a&sourceUrl=http://en.mtvpad.com/3/index.html#md"  target="_blank"></a></li>
...
<!--bananer-->
<div class="mainpage1">
	<a class="btn1" href="/web/shopCart!toQuickOrder.action?shopFlag=tvpaden&productCode=0e55accec6f44cd484dc6ca30ba46b3a&sourceUrl=http://en.mtvpad.com/3/index.html#md"  target="_blank"><img src="${resDomain}/en/res/tvpad4zt_mac/images/btnEn_1.png" /></a>
    <a class="btn2" href="http://www.mtvpad.com/3/index.html">去中文頁</a>
...
<div class="mainpage2">
	...
	<div class="mainpage2_buttom">
    	<a class="sale" href="/web/shopCart!toQuickOrder.action?shopFlag=tvpaden&productCode=0e55accec6f44cd484dc6ca30ba46b3a&sourceUrl=http://en.mtvpad.com/3/index.html#md"  target="_blank">Get $130 Off</a>
    </div>
</div>
<!--瞭解TVpad4-->
<div class="mainpage3">
