...
<!--top -->
	<div class="top" id="sc_top">
		...
		<div class="top_submenu">
			<div class="top_submenu1">
				<p class="collection">
					<img src="${resDomain}/bscn/res/images/collect.gif" /> 
				...
				<p class="submenu">
					...
					<img src="${resDomain}/bscn/res/images/buy.gif" /> <a href="javascript:toCar('${storeDomain}');">购物车</a><font class="white">（<span id="shopCartNum"></span>）</font>
					|
	...
	<div class="menu">
		<div class="menu_a">
			...
			<ul>
				<cus:navigation storeKey="bmcn" style="3"></cus:navigation>
			</ul>
		</div>
	</div>
	<!--end menu-->
	...
	<div id="tx_b" style="top:124px;position: absolute;display: none;z-index:9999;">
		<div class="pop_up_box" style="background:white;">
			<span class="box_l">用户登录<span class="box_r"><a href="javascript:onhide('tx_b','loginDiv');"><img src="${resDomain}/bscn/res/images/close.gif" border="0" /></a></span></span>
