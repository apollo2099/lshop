...
<script type="text/javascript"  src="${resDomain}/mbscn/res/js/jquery.hammer.js"></script>
<script type="text/javascript" src="${resDomain}/mbscn/res/js/product.js"></script>
<style type="text/css">
#curspan{height: 42px;}
</style>
</head>
...
<form id="buyForm" action="" method="post">
  ...
  <div class="bigimg">
    ...
    <div class="imgreture1">
		...
		<div id="p_orgin_price_area" class="baoyou" p="${product.code}">
			<span class="imgprcont">价格:</span>&nbsp;&nbsp;<i class="usd" id="p_orign_price">USD ${product.price  }</i>
	    </div>
     	...
     	<s:iterator value="page.list" status="stat" id="obj">
     		<div class="detailcoment-box">
		        <div class="comentname">
		          <strong><c:choose><c:when test="${fn:contains(obj[1].nickname, '@')}">${fn:substringBefore(obj[1].nickname, '@')}</c:when><c:otherwise>${obj[1].nickname}</c:otherwise></c:choose><img src="${resDomain }/mbscn${obj[0] }" /></strong>
		          <span>
        ...
        <ul>
        	...
        	<c:if test="${vs.index < 2}">
	            ...
	            <div class="libox" id="libox">
	             ...
	             <div class="imgjia">
	              <span></span>
	              <span class="p_price" f="${r.storeId}" p="${r.code}" >${lvStore.currency} ${r.price  }</span>
	             </div>
	            </div>
	          </li>
	        </c:if>
...
<script type="text/javascript" src="${resDomain}/mbscn/res/js/slider.js"></script>
...
<script type="text/javascript" src="${resDomain}/mbscn/res/js/html.js"></script>
</body>
</html>
