...
<title>Pay Failure-HUA YANG MALL</title>
	...
	<div class="buy">
	  <div class="message" style="background:#FEFFED;">
				...
				<ul>
			  	  ...
			  	  <li class="wz" style="padding-top:20px;">You failed to pay order ${oid}.<br /><br />
			  	   <a href="/web/userOrder!toConfirmPay.action?oid=${oid}">Order Repay</a><br />
				  </li>
				</ul>	
