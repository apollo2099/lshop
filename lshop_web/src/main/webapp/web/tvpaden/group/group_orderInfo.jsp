			...
			<div class="fill_orders">
				...
				<div class="fill_orders01">
						...
						<form id="addressForm" action="/web/group!addAddress.action" method="post">
						 ...
						 <div class="pay">
								...
								<cus:paymethod></cus:paymethod>
									<li id="aa" style="display:none;"><font class="redfont">Shipping Cost：USD <span id="carriage">${carriage}</span></font></li>
					...
					<div class="buy_order" id="shopDiv">
						...
						<ul class="sum"><span id="showData">Total：USD <u:formatnumber value="${amount }"  type="number" groupingUsed="false" maxFractionDigits="2"/>+ Shipping Cost:USD <span id="allCarriage">${carriage}</span></span></ul>
						<ul class="sum01">Merchandise Subtotal：<font class="redfont">USD <span id="amount"><u:formatnumber value="${amount+carriage}"  type="number" groupingUsed="false" maxFractionDigits="2"/></span></font></a></ul>					
					</div>	
					<div class="pay">
