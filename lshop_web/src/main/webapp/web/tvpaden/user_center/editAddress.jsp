...
<div class="content_main">
	...
	<%@include file="/web/tvpaden/user_center/leftFrame.jsp" %>
	 ...
	 <div class="right_frame">
	 	<h1><span class="s_r"><font class="bfont"><img src="${resDomain}/tvpaden/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">Home</a>--><a href="/web/userCenterManage!getAccount.action">User Center</a>--></font> Edit billing address</span></h1> 
		...
		<form action="/web/userCenterManage!editAddress.action" method="post" id="myform">
			...
			<ul>
				...
				<li class="wd2"><input name="lvAccountAddress.relName"  type="text" class="input2" value="${lvAccountAddress.relName }" /><font class="redfont">(English Only)</font>
				</li>
		    </ul>
		...
		<ul>
			...
			<li class="wd2">
			<input  name="lvAccountAddress.adress" id="adress" type="text" class="input2" value="${lvAccountAddress.adress }" onfocus="if(this.value=='Street')this.value=''" onblur="if(this.value=='')this.value='Street'"/> 
			-<input  name="lvAccountAddress.cityName" id="cityName" type="text" class="input2" value="${lvAccountAddress.cityName }" onfocus="if(this.value=='County/City')this.value=''" onblur="if(this.value=='')this.value='County/City'"/>
			...
			<c:if test="${empty provinceList}">
				<input type="text" name="lvAccountAddress.provinceName" id="provinceName" class="input2" value="${lvAccountAddress.provinceName }"  onfocus="if(this.value=='State/Province')this.value=''" onblur="if(this.value=='')this.value='State/Province'"/> 
			</c:if>
		...
		<ul class="btn">
			<li class="wd1">&nbsp;</li>
			<li class="wd2"><input type="image" onclick="onSub();" src="${resDomain}/tvpaden/res/images/user_center_btn.gif" width="101" height="34" /></li>
		</ul>
		</form>
