...
<div class="pop_up_box" style="background-color: white;">
	<span class="box_l">解除绑定<span class="box_r">
	...
	<div class="remove_bingding">					    
		   <ul>
			...
			<li class="wd1">&nbsp;</li>
			<li class="wd2">
				<input type="button" onclick="javascript:submitUnbinding();" value="解除绑定" class="user_center_bt" />
				<input type="button" onclick='ymPrompt.doHandler("ok",undefined)' value="取 消" class="user_center_bt03"  />
			</li>
		</ul>		
	</div>
</div>
