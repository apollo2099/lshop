		...
		<div class="content_main">
			...
			<%@include file="/web/bmcn/user_center/leftFrame.jsp" %>
			 ...
			 <div class="right_frame">
			 	<h1><span class="s_r"><font class="bfont"><img src="${resDomain}/bmcn/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">首页</a> --><a href="/web/userCenterManage!getAccount.action"> 用户中心</a> --></font> 现在支付</span></h1> 
			     ...
			     <div class="order"> <span class="order_t"><font class="fontwz">订单确认,清您核对订单信息</font></span>
			       ...
			       <ul class="long">
			         ...
			         <li class="long">
				         <s:if test="#request.lvOrder.payStatus==0">
			          		<font class="redfont">待付款</font> <img src="${resDomain}/bmcn/res/images/personel_center_icon03.gif" width="16" height="16" /> <a href="/web/userOrder!toConfirmPay.action?oid=${lvOrder.oid }&shopFlag=${lvOrder.storeId }">现在支付</a>
			          	</s:if>
			       ...
			       <table width="710" height="188" border="0" cellpadding="0" cellspacing="1" bgcolor="#E8E5E5">
		               ...
		               <tr style="text-align:right;">
		               	 <td height="42" colspan="5" bgcolor="#F9F8F8" style="padding-right:30px;"><div align="right">商品总金额：${lvOrder.currency} ${allAmount} <c:if test="${not empty coupon}">- 优惠券减免：${lvOrder.currency} ${lvOrder.couponTotalPrice} </c:if> + 运费:${lvOrder.currency} ${lvOrder.postprice }</div></td>
		               </tr>
		               <tr style="text-align:right;">
