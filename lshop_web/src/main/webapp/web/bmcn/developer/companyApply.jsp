...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$(function(){
		...
		function checkDate(form){
			...
			if(!checkInput(company,128)){
				showMsg("company","请输入128长度以内的公司名称");
				issubmit= false;
			}
			
			if(!checkInput(idNum,18)){
				showMsg("idNum","请输入18长度以内的营业执照注册号");
				issubmit= false;
			}
			...
			if(!checkInput(name,32)){
				showMsg("contactName","请输入32长度以内的联系人");
				issubmit= false;
			}
			...
			if(!checkInput(address,128)){
				showMsg("address","请输入128长度以内的公司地址");
				issubmit= false;
			}
...
<div class="application1" style="height:420px">
   <div class="posit">
      <h2 class="bt3" id="nbt">
	    <p class="home"><img src="${resDomain}/bmcn/res/images/icon02.gif" /></p><p><a href="${storeDomain}/web/index!toIndex.action">首页</a> > <a href="${storeDomain}/web/developer!developerIndex.action">注册开发者</a>  > 企业开发者 </p>
	  </h2>
   </div> 
   <div class="clear"></div> 
  <div class="app_submit">
  	   <form action="${storeDomain}/web/developer!apply.action" method="post" enctype="multipart/form-data" onsubmit="return checkDate(this)">
	      <input type="hidden" name="developer.dtype" id="dtype" value="1" />
	       <input type="hidden" name="developer.isAgree" id="isAgree" value="${developer.isAgree}" />
     <table width="100%" border="0">
  <tr>
    <td width="35%" height="40" align="right"><p><span class="star">*</span>公司名称：</p></td>
    <td width="28%" height="40">
      <input type="text"  name="developer.company" id="company"  value="${developer.company}"  class="inttext"/></td>
    <td width="37%" height="40"><span class="star errormsg"></span></td>
  </tr>
  <tr>
    <td height="40" align="right"><p><span class="star">*</span>营业执照注册号：</p></td>
    <td height="40"><input type="text" name="developer.idNum" id="idNum"  value="${developer.idNum}" class="inttext"/></td>
    <td height="40"><span class="star errormsg"><c:choose><c:when test="${status eq '3'}">营业执照注册号已被注册</c:when></c:choose> </span></td>
  </tr>
  <tr>
    <td height="40" align="right"><p><span class="star">*</span>营业执照扫描件：</p></td>
    <td height="40">
     <div class="upload">
    	 <div class="upload">
  ...
  <tr>
    <td height="40" align="right"><p><span class="star">*</span>联系人姓名：</p></td>
    <td height="40"><input type="text" name="developer.contactName"  value="${developer.contactName}" id="contactName" class="inttext"/></td>
  ...
  <tr>
    <td height="40" align="right"><p><span class="star">*</span>公司地址：</p></td>
    <td height="40"><input type="text" name="developer.address" id="address"  value="${developer.address}" class="inttext"/></td>
    <td height="40"><span class="star errormsg"></span></td>
  </tr>
  <tr>
...
<div class="xieyi" id="xieyi" style="top:150px;position: absolute;display: none;z-index:9999;" >
  <div class="context_xieyi_title"><strong>第三方应用入驻协议</strong></div>
