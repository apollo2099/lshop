...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="application1">
		   <div class="posit">
		      <h2 class="bt3" id="nbt">
			    <p class="home"><img src="${resDomain}/bmcn/res/images/icon02.gif" /></p><p><a href="${storeDomain}/web/index!toIndex.action">首页</a> > 提交成功信息</span> </p>
			  </h2>
		   </div>  
		   <div class="apl_title">  
		      <div class="app_detil">
		        提交成功，请耐心等待审核，审核结果将发送至注册邮箱请注意查收，如有疑问请与我们客服人员进行联系。
		         <br />
	...
	<img src="${storeDomain}/web/developer!view.action"/>
