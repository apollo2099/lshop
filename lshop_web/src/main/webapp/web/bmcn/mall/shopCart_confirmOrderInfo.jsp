				...
				<div class="fill_orders01">
					...
					<div class="buy_order">
						...
						<c:if test="${not empty msg}">
							<div style="width:265px; background:#FFFFCB; height:25px; line-height:22px; text-align:right; padding-top:8px; color:#FF0000; padding-right:30px;padding-left:700px; border-bottom:1px #e5e5e5 solid;"><p class="cx"><img src="${resDomain}/bmcn/res/images/pos_icon.gif" /></p> <p class="cx">订单金额已发生改变，请重新确认 ！</p></div>
						</c:if>	
					</div>	
					<div class="pay">	
						<h1>支付方式</h1>
