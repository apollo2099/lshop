...
<div class="content_main">
  ...
  <div class="right_frame">
	 	<h1><font class="bfont"><img src="${resDomain}/bmcn/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">首页</a> --><a href="/web/userCenterManage!getAccount.action"> 用户中心</a> --><a href="/web/recharge!list.action"> 账户余额</a> --></font> 支付取消</h1> 
		<div class="usercenter_box">
		  <div class="user_center_right">
            <ul>
	          <li class="center"><img src="${resDomain}/bmcn/res/images/suc.gif" /> <font style="font-size: 14px; font-weight: bold;">您已取消订单 ${charge.rnum} 的支付交易！</font></li>
			</ul>
			<ul>
			  <li class="center">
