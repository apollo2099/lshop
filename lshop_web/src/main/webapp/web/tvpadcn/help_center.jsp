...
<div class="content_main">
       ...
       <div class="cm_ad_left"><img src="${resDomain}/tvpadcn/res/images/pic01.gif" width="200" height="250" /></div>
    </div> 
 	<!--End left_Frame-->
 	
	 
	 <div class="right_frame">
	 		<h1><img src="${resDomain}/tvpadcn/res/images/icon02.gif" /><font class="bfont"><a href="/index.html">首頁</a>--> <a href="/web/helpCenter!getHelps.action">幫助中心</a>--></font>購物流程 </h1>
