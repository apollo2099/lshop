...
<div class="content_main">
	...
	<%@include file="/web/tvpadcn/user_center/leftFrame.jsp" %>
	 ...
	 <div class="right_frame">
	 	<h1><span class="s_r"><font class="bfont"><img src="${resDomain}/tvpadcn/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">首頁</a>--><a href="/web/userCenterManage!getAccount.action">用戶中心</a>--></font> 新增收貨地址</span></h1> 
		<div class="usercenter_box">
		<font color="red">${msg}</font>
	    <% session.removeAttribute("msg"); %>
	    <font color="red">*為確保及時收到我們的產品，請填寫真實地址（英文）</font>
		<form action="/web/userCenterManage!addAddress.action" method="post" id="myform">
			<ul>
				<li class="wd1"><font class="redfont">*</font>收貨人姓名：</li>
				<li class="wd2"><input name="lvAccountAddress.relName" class="input2"  type="text" id="relName"/><font class="redfont">(姓名必須為英文)</font>
				</li>
		    </ul>
		...
		<ul class="btn">
			<li class="wd1">&nbsp;</li>
			<li class="wd2"><input type="image" src="${resDomain}/tvpadcn/res/images/user_center_btn05.gif" width="101" height="34" /></li>
		</ul>
		</form>
