...
<article>
   <div class="shan_login"> 
     <div class="he_login">合作网站账号登陆</div>
     <div>
    <a href="/web/threeauth!facebook.action"><img src="${resDomain}/mtmcn/res/images/login_facebook.png" /></a>
    <a href="/web/threeauth!qq.action"><img src="${resDomain}/mtmcn/res/images/QQ.png"></a>
    <%--
    <a href="#"><img src="${resDomain}/mtmcn/res/images/wx.png" /></a>
     --%>  
    </div> 
 </div>
</article>
