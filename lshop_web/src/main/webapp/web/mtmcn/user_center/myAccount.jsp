...
<article>
   <section>
      <div class="tucubg">
          ...
          <div class="tucubg_wel"><c:out value="${lvUserSubscribe.userName }" default="${lvUserSubscribe.email }" /><br/>欢迎访问TVpad商城！</div>
          <div class="tucubg_bt"><a href="${MallPath}/web/userCenterManage!logout.action"><img src="${MallPath}${resDomain}/mtmcn/res/images/rebt.gif" /></a></div>
      </div>
   </section>
