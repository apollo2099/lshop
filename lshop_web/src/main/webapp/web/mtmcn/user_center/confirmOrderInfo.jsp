...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>用户中心_TVpad商城</title>
		<link href="${resDomain}/mtmcn/res/css/user_center.css" rel="stylesheet" type="text/css" />
		<!-- 加载公共JS -->
	...
	<body>
		...
		<div class="content_main">
			...
			<!-- left_frame -->
			<%@include file="/web/mtmcn/user_center/leftFrame.jsp" %>
			 
			 <div class="right_frame">
			 	<h1><span class="s_r"><font class="bfont"><img src="${resDomain}/mtmcn/res/images/icon02.gif" width="15" height="15" /><a href="/index.html">首页</a>--><a href="/web/userCenterManage!getAccount.action">用户中心</a>--></font> 现在支付</span></h1> 
			     ...
			     <div class="order"> <span class="order_t"><font class="fontwz">订单确认,清您核对订单信息</font></span>
			       ...
			       <ul class="long">
			         ...
			         <li class="long">
				         <s:if test="#request.lvOrder.payStatus==0">
			          		<font class="redfont">待付款</font> <img src="${resDomain}/mtmcn/res/images/personel_center_icon03.gif" width="16" height="16" /> <a href="/web/userOrder!toConfirmPay.action?oid=${lvOrder.oid }&shopFlag=${lvOrder.storeId }">现在支付</a>
			          	</s:if>
			       ...
			       <table width="710" height="188" border="0" cellpadding="0" cellspacing="1" bgcolor="#E8E5E5">
		               ...
		               <tr style="text-align:center;">
		                 ...
		                 <td bgcolor="#F9F8F8" style="text-align:center;"><font class="redfont fontwz">${moneyMark}${obj[1].oprice }</font></td>
		               ...
		               <tr style="text-align:right;">
		               	 <td height="42" colspan="5" bgcolor="#F9F8F8" style="padding-right:30px;"><div align="right">商品总金额：${moneyMark}${allAmount} + 运费:${moneyMark}${lvOrder.postprice }</div></td>
		               </tr>
		               <tr style="text-align:right;">
		               	 <td height="42" colspan="5" bgcolor="#F9F8F8" style="padding-right:30px;"><div align="right">应付金额：<font class="fontwz redfont">${moneyMark}${lvOrder.totalPrice }</font></div></td>
		               </tr>        
		           </table>
