...
<script type="text/javascript" src="${resDomain}/mtmcn/res/js/recharge.js"></script>
...
<form action="/web/recharge!doOrder.action" method="post" id="doorderform">
 ...
 <div class="vb_box">  
	<table width="246" align="center" cellpadding="0" cellspacing="0" style="display:block" class="help_recharges" 
	id="item_account">
	<tr>
	<td width="18%" height="60" align="left" class="fonsi"  style="color:#52555B;font-family:'宋体'">账号：</td>
    <td width="82%" height="60" colspan="3">
	<div  class="inputd" >
		<input type="text" class="inpu inpu1" value="${requestScope.email}" name="recharge.accounts" id="accouts" maxlength="60" />  
		<div class="tip">
	     	<em></em>
...
1.V币充值到您的帐户后，不能赠送给其他帐户，若想给好友充值，
请选择“帮人充值”的充值方式。<br>
