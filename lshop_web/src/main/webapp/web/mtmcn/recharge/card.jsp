...
<article>
  ...
  <tr>
    ...
    <td width="14%" align="right" class="asty"><img src="/web/phoneimager.jsp" id="codeId" style="vertical-align: middle;" /></td>
    <td width="20%" align="right" class="asty"><span style="color:#0068b7" onclick="changeCodeImg()">看不清楚? 换一张</span></td>
  </tr>
