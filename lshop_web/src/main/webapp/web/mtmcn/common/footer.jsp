...
<gv:esi uri="/web/mtmcn/common/footer.jsp">
<article>
	<div  class="fastchannel"><img src="${resDomain}/mtmcn/res/images/fastchen.png" width="100%"/></div>
	...
	<div class="maketips">
		<div class="fastnav">
			...
			<a href="/web/userCenterManage!getAccount.action" id="usersa"></a> <a
				href="${storeDomain}/tvpad4/index.html" id="tvpada"></a> <a
