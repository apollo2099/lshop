...
<div class="main_conten3">
	<!--我的推广码-->
	<div class="theorder">
		<ol class="f_B">推广码<span class="f_orange"> ${objList[0][1]}</span> 的推广订单详细情况</ol>
		<ul>
			<li class="my_od">
				<p class="od01">买家姓名</p>
				<p class="od02">推广码</p>
		...
		<ul class="page" style="float:right;">
				  <u:page href="promtManager!getDetailList.action?couponCode=${couponCode }&balanceId=${balanceId }&page.pageNum=@"></u:page>
				   <script type="text/javascript">
					<!--
					function gotoPage(num){
					   window.location.href="promtManager!getDetailList.action?couponCode=${couponCode }&balanceId=${balanceId }&page.pageNum="+num;
