...
function getAllStores(){
	if(data.length>=1){
		...
		$.each(data[1],function(n,store) { 
			...
			if(store.isHot==1){
				str += "<img src='${resDomain}/en/res/images/hot.gif'  class='hot'/>";
			} 
			str += "</p>";
...
function getContinent(id){
	...
	//获取对应的国家
	if(data.length>=1){
		var str = "<dt>Country</dt>";
		str += "<dd>";
		$.each(data[2],function(n,obj) { 
			if(obj[0].id==id){
				//超过两行显示更多
				if(obj[1].length>14){
					str += "<p class='shouqi' onclick='showMoreCountry("+id+");'>more <img src='${resDomain}/en/res/images/gengduo1.gif' /></p>";
				}else{
...
function showMoreCountry(id){
	...
	$.each(data[2],function(n,obj) { 
		if(obj[0].id==id){
			str += "<p class='shouqi' onclick='showLessCountry("+id+");'>collapse <img src='${resDomain}/en/res/images/shouqi.gif' /></p>";
			$.each(obj[1],function(n,country) {
	...
	if(data.length>=1){
		...
		$.each(data[3],function(n,obj) {
			if(obj[0].id==id){
				//超过两行显示更多
				if(obj[1].length>14){
					str += "<p class='shouqi' onclick='showMoreCity("+id+");'>more <img src='${resDomain}/en/res/images/gengduo1.gif' /></p>";
				}else{
					str += "<p class='shouqi'></p>";
				}
				$.each(obj[1],function(n,city) {
...
function showMoreCity(id){
	...
	$.each(data[3],function(n,obj) {
		if(obj[0].id==id){
			str += "<p class='shouqi' onclick='showLessCity("+id+");'>collapse <img src='${resDomain}/en/res/images/shouqi.gif' /></p>";
			$.each(obj[1],function(n,city) {
