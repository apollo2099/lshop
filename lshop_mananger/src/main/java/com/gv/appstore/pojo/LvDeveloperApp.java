...
public class LvDeveloperApp extends BasePo implements java.io.Serializable {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
				...
				.append("Url", getUrl()).append("AppVersion", getAppVersion())
				.append("Lang", getLang()).append("AppType", getAppType())
				.append("KeyWord", getKeyWord())
				.append("AppDesc", getAppDesc())
				.append("ProofUrl", getProofUrl())
				.append("DemoImgsUrl", getDemoImgsUrl())
				.append("IsCharge", getIsCharge()).append("IsAd", getIsAd())
	...
	public boolean equals(Object obj) {
		if (obj instanceof LvDeveloperApp == false)
			return false;
		if (this == obj)
			return true;
