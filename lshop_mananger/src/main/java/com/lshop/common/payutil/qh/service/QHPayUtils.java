...
public class QHPayUtils {
	...
	public static TranckInfoVo uploadTrackNo(String account, String terminal,
		...
		createMap.put("tracking_handler",trancking_handler);
	 ...
	 * @return void
	 */
	private static OrderInfoVo xmlParseOrderInfo(String sHtmlText)throws DocumentException {
	 ...
	 * @return TranckInfoVo
	 */
	private static TranckInfoVo xmlParseThanckInfo(String sHtmlText)throws DocumentException{
