...
public class Constants {
	...
	//点击连接活动关系定义
	public static Map<String,List<LvActivityLink>> ACTIVITY_LINK = new HashMap<String,List<LvActivityLink>>();
	...
	public static String AD_TVPAD_MORE_PROD_RIGHT ="AD_TVPAD_MORE_PROD_RIGHT";//商城更多右侧广告
	...
	public static String AD_TVPAD_THIRD_ZT ="AD_TVPAD_THIRD_ZT";//商城第三方购买平台专题广告位
	public static String AD_TVPAD_STAT_SHOPCART ="AD_TVPAD_STAT_SHOPCART";//商城购物车统计代码广告位
	public static String AD_TVPAD_STAT_PAY ="AD_TVPAD_STAT_PAY";//商城支付成功统计代码广告位
	...
	static{
		...
		PAY_METHODS.put(PAY_METHOD_ALIPAY_INITIAL, "支付宝国际卡银行支付");
	...
	static{
		...
		AD_TVPAD.put("AD_TVPAD_MORE_PROD_RIGHT", "商城更多右侧广告");
		...
		AD_TVPAD.put("AD_TVPAD_THIRD_ZT", "TVpad第三方购买平台广告位");
		AD_TVPAD.put("AD_TVPAD_STAT_SHOPCART", "商城购物车统计代码广告位");
		AD_TVPAD.put("AD_TVPAD_STAT_PAY", "商城支付成功统计代码广告位");
	}
	...
	public final static String TEMP_FILE_PATH = "temp/output/";	// 临时文件存放目录
	
	public static final String HTTPS_USER = PropertiesHelper.getProperty("https.user.agent");
//	public static final String HTTPS_KEY_DIR = PropertiesHelper.getProperty("https.keyStore.dir");
//	public static final String HTTPS_KEY_PWD = PropertiesHelper.getProperty("https.keyStore.pwd");
	public static final String HTTPS_TRUST_DIR = PropertiesHelper.getProperty("https.trustStore.dir");
	public static final String HTTPS_TRUST_PWD = PropertiesHelper.getProperty("https.trustStore.pwd");
	public static final String HTTPS_SERVER_KEY_DIR =PropertiesHelper.getProperty("https.server.keyStore.dir");
	public static final String HTTPS_SERVER_KEY_PWD =PropertiesHelper.getProperty("https.server.keyStore.pwd");
