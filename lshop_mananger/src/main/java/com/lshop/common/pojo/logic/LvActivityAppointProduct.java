 ...
 */public class LvActivityAppointProduct extends BasePo implements java.io.Serializable{
	...
	private java.lang.Short givenTypeNum;
	...
	private List<LvActivityGift> acGiftList;//活动赠品数据集合
	 ...
	 * 赠送类型字典(1赠送优惠券,2赠送抽奖机会,3赠送赠品)       db_column: given_type_num 
	 */
	public void setGivenTypeNum(java.lang.Short value) {
		this.givenTypeNum = value;
	}
	/**
	 * 赠送类型字典(1赠送优惠券,2赠送抽奖机会,3赠送赠品)       db_column: given_type_num 
	 */
	public java.lang.Short getGivenTypeNum() {
	...
	public List<LvActivityGift> getAcGiftList() {
		return acGiftList;
	}

	public void setAcGiftList(List<LvActivityGift> acGiftList) {
		this.acGiftList = acGiftList;
	}
