...
package com.lshop.manage.lvTplDetail.service;
 ...
 * @version 1.0
 * @since 1.0
 */public interface LvTplDetailService extends BaseService{
	
	/**
	 * 获得所有
	 */
	public List<LvTplDetail> findAll(Dto dto) throws ServiceException;
