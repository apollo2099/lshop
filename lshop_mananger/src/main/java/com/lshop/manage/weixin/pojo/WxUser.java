 ...
 */
 public class WxUser extends BasePo implements java.io.Serializable{
	...
	public String getBindTimeString() {
		return DateConvertUtils.format(getBindTime(), FORMAT_BIND_TIME);
	}
	/**
	 * 绑定时间       db_column: bind_time 
	 */
	public void setBindTimeString(String value) {
		setBindTime(DateConvertUtils.parse(value, FORMAT_BIND_TIME,java.util.Date.class));
	}
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("LastObtainTime",getLastObtainTime())
			.append("ObtainAmount",getObtainAmount())
			.toString();
	}
