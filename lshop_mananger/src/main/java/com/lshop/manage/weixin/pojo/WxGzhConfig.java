 ...
 */
 public class WxGzhConfig extends BasePo implements java.io.Serializable{
	 ...
	 * 凭证获取时间       db_column: access_token_time 
	 */
	public String getAccessTokenTimeString() {
		return DateConvertUtils.format(getAccessTokenTime(), FORMAT_ACCESS_TOKEN_TIME);
	}
	/**
	 * 凭证获取时间       db_column: access_token_time 
	 */
	public void setAccessTokenTimeString(String value) {
		setAccessTokenTime(DateConvertUtils.parse(value, FORMAT_ACCESS_TOKEN_TIME,java.util.Date.class));
	}
