...
<div class="page">
	<div class="pageContent">
		<form rel="" action="/manager/devMngAction!verify.action?json.navTabId=${json.navTabId}" 
		...
		<div class="" style="border-top-width: 0px;">
				<dl style="width: 100%;text-align: right;">
					<dt>状态：</dt>
					<dd>
						<select name="developer.dstatus" style="width: 135px;" id="verify_select">
				...
				<dl style="width: 100%;text-align: right;display: none;" id="v_not_reason">
					<dt>不通过原因：</dt>
					<dd>
				     <textarea name="developer.reason" maxlength="200" style="height: 100px;width: 300px;"></textarea>
					</dd>				  
				</dl>
