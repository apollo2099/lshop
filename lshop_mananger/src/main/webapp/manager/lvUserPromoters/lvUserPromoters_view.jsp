...
<!-- 
 ...
 -->
				...
				<dl>
					<dt>状态：</dt>
					<dd>
					<s:if test="lvUserPromoters.approvalStatus==0">未审核</s:if><s:elseif test="lvUserPromoters.approvalStatus==1">审核通过</s:elseif><s:elseif test="lvUserPromoters.approvalStatus==-1">审核未通过</s:elseif>
