...
<form id="pagerForm" method="post" action="lvUserPromotersMngAction!gradelist.action" >
...
<div class="page">
	<div class="pageHeader">
	   <form onsubmit="return navTabSearch(this);" action="lvUserPromotersMngAction!gradelist.action" method="post" rel="pagerForm">
	...
	<div class="pageContent">
		<div class="panelBar">
		 <ul class="toolBar">
				  <li><a class="edit" href="lvUserPromotersMngAction!exportExl.action?json.navTabId=${json.navTabId}" target="dwzExport" title="导出excel?" rel="ids"><span>导出EXCEL</span></a></li>  
		 </ul>
		</div>
		<table class="table" width="100%" layoutH="170">
				...
				<tr>
					<th width="22"><input type="checkbox" group="ids" class="checkboxCtrl"></th>
						<!-- 生成表单 -->
					        ...
					        <th orderField="settlementedNum" class="${orderField eq 'settlementedNum' ? orderDirection : ''}">已结算台数</th>
					        <th>未结算台数</th>
			...
			<tbody>
				...
				<tr>
					...
					<td>${item.settlementedAmount+item.nonSettlementAmount+item.settlementAmount}</td>
					<td>
