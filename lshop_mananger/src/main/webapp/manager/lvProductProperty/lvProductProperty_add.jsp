	...
	<form method="post"
			...
			onsubmit="return validateCallbackFrom(this, dialogAjaxDone);">
  		    <div class="pageFormContent" layoutH="56">
				...
				<dt>属性标题：</dt>
				    <dd>
				     <input name="lvProductProperty.title" type="text" size="32" maxlength="128" class="required" />
				    </dd>
				</dl>
				...
				<dt>排序：</dt>
					<dd>
                    <input name="lvProductProperty.sortId" type="text" size="32" maxlength="4"  class="digits"/>
					</dd>				  
				</dl>
		</div>
