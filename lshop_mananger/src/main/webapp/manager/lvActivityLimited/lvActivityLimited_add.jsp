		...
		<form method="post" action="lvActivityAction!save.action?json.navTabId=${json.navTabId}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
			...
			<div class="pageFormContent" layoutH="56">
				...
				<dl>
				    <dt>选择商品：</dt>
				    <dd>
				   <input id="inputOrg1" name="lvActivityLimited.productCode" value="" type="hidden"/>
				   <input class="required" name="lvActivityLimited.productName" type="text" postField="keyword" readonly="readonly" lookupGroup="lvActivityLimited"/>
				   <a class="btnLook" href="#" lookupGroup="lvActivityLimited" id="selProduct" style="display:none">查找带回</a>	
				    </dd>
				</dl>
				<dl>
				    <dt>活动金额：</dt>
				    <dd>
				     <input name="lvActivityLimited.activityPrice" type="text" size="32" maxlength="5" class="required numberAPoint"/>
				    </dd>
				</dl>
				<dl>
				    <dt>活动限量：</dt>
				    <dd>
				     <input name="lvActivityLimited.limitTotal" type="text" size="32" maxlength="9" class="required digitsNoZore"/>
				    </dd>
				</dl>
				<dl>
				    <dt>活动状态：</dt>
