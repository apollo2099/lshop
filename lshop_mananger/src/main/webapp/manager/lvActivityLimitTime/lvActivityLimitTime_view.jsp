...
<div class="page">
	...
	<dl>
				...
				<dl>
				    <dt>活动类型：</dt>
				    <dd>
			            <gv:dictionary type="text" code="ACTIVITY_TYPE" value="${lvActivity.typeKey}" disabled="disabled"/>
				    </dd>
				</dl>
				<dl>
				    <dt>选择店铺：</dt>
				    <dd>
			            ...
			            <c:if test="${lvActivityLimitTime.storeId==s.storeFlag }">${s.name }</c:if>
						</c:foreach>
				    </dd>
				</dl>
                ...
                <dl>
				    <dt>活动金额：</dt>
				    <dd>
                        ${lvActivityLimitTime.activityPrice }
				    </dd>
				</dl>
                ...
                <dl>
				    <dt>活动状态：</dt>
				    <dd>
						<gv:dictionary type="text" code="ACTIVITY_STATUS" name="lvActivity.status" value="${lvActivity.status }" disabled="disabled"/>
				    </dd>
				</dl>
