	...
	<form method="post"
  		...
  		<div class="pageFormContent" layoutH="56">
			<dl>
					...
					<option value="">
						请选择类别
				         ...
				         <s:iterator value="#request.productList" id="product">
							<option
							 <c:if test="${lvProductImage.productCode==product.code }">selected="selected"</c:if> 
							 value="${product.code}" >
								${product.productName }
							</option>
						</s:iterator>
				...
				<dt>排序值：</dt>
				    <dd>
				  <input type="text" name="lvProductImage.sortId" value="${lvProductImage.sortId }" maxlength="4" class="digits" size="32">
				    </dd>
				</dl>
				<dl>
	              <dt>创建时间：</dt>
					<dd>
                        <input type="text" name="lvProductImage.createTime" class="date" format="yyyy-MM-dd HH:mm:ss" readonly="true" size="32"
				...
				<dt>最后修改时间：</dt>
					<dd>
                       	<input type="text" name="lvProductImage.modifyTime" class="date" format="yyyy-MM-dd HH:mm:ss" readonly="true" size="32"
